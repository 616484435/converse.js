...
import { Connection } from '@converse/headless/connection.js';
import { MockConnection } from '@converse/headless/mock-connection.js';
...
export const _converse = {
    ...
    isTestEnv: () => {
        return api.settings.get('bosh_service_url') === 'montague.lit/http-bind';
    },
